        ...
        <table className="w-full text-sm border-collapse">
          <thead>
            <tr className="bg-slate-100/80 border-b border-slate-200">
              <th className="px-4 py-3 text-left text-[10px] font-bold text-slate-600 uppercase tracking-wider border-r border-slate-200/60 w-10">#</th>
              {headers.map((h, i) => {
                const isMapped = mapping && mapping[h];
                return (
                  <th key={i} className="px-4 py-3 text-left border-r border-slate-200/60 last:border-0">
                    <div className="flex flex-col gap-0.5">
                      <span className="text-[10.5px] font-bold text-slate-600 uppercase tracking-wider">{h}</span>
                      {isMapped && (
